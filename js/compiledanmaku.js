...
window.DanmakuCompilerRuntime.executeBlock = function(p, state, b, attacker, target, _util) {
    ...
    switch (p.type) {
                    ...
                    case 'wait_frame':
                    case 'wf': {
                        let framesVal = evalExpr(p.frames !== undefined ? p.frames : (p.duration !== undefined ? p.duration : '1'), state.variables, block, 'frames');
                    ...
                    case 'set_var': {
                        ...
                        window.setScriptVariable(state, varName, val, p.type === 'const_var');
                    ...
                    case 'change_var': {
                        ...
                        if (!state.constVars.has(varName)) {
                            ...
                            window.setScriptVariable(state, varName, newVal, false);
                        }
                        syncAttackerFromEmitterVariables(state, attacker);
                        break;
                    }
                    ...
                    case 'bullet': {
                        let bp = (typeof p !== 'undefined' ? (p.params || p) : (p || block));
                        ...
                        let bColor = window.DanmakuCompilerRuntime.resolveColorParam(bp.color || '#ff3333', state.variables);
                        ...
                        for (let k = 0; k < countVal; k++) {
                            ...
                            newBullet.bulletState = _util._initBulletState(cScript, speed, curAngle, attacker, target, cFn);
                        ...
                        break;
                            ...
                            case 'bullet': {
                                ...
                                if (coordMode === 'absolute') {
                                    ...
                                    let baseX = state.variables.x !== undefined ? state.variables.x : (b ? b.x : (window.DanmakuCompilerRuntime._getCurrentX(b, attacker, state)));
                                    let baseY = state.variables.y !== undefined ? (isPlayerSide ? canvas.height - state.variables.y : state.variables.y) : (b ? b.y : (window.DanmakuCompilerRuntime._getCurrentY(b, attacker, state, window.canvas ? window.canvas.height : 900)));
                                    spawnX = baseX + (state.variables.x_offset || 0) + ox;
                                    spawnY = baseY + (state.variables.y_offset || 0) + (isPlayerSide ? -oy : oy);
                                }
...
window.compiledDanmaku['danmaku_1_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffffff").trim().toLowerCase())) {
      ...
      if (!state.onceMap['lhdh24euf']) {
        state.onceMap['lhdh24euf'] = true;
        vars['x'] = 384;
        vars['y'] = 448;
      }
    }
...
window.compiledDanmaku['danmaku_2_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['9uevzrj20']) {
      state.onceMap['9uevzrj20'] = true;
      vars['m'] = 1;
    }
...
window.compiledDanmaku['danmaku_3_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['bn42xtdrg']) {
      state.onceMap['bn42xtdrg'] = true;
      vars['m'] = 1;
    }
    if (!!((vars.isTouchEdge !== undefined ? vars.isTouchEdge : 0))) {
      if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
    ...
    if (!!((vars.m !== undefined ? vars.m : 0)===0)) {
      ...
      for (let _loopIdx_2 = 0, _limit_2 = Math.round(5); _loopIdx_2 < _limit_2; _loopIdx_2++) {
        ...
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.05);
          yield;
        }
      }
      vars['i'] = _prev_i_2;
...
window.compiledDanmaku['danmaku_4'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_3 = 0, _limit_3 = Math.round(36); _loopIdx_3 < _limit_3; _loopIdx_3++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.01);
        yield;
      }
    }
    vars['i'] = _prev_i_3;
...
window.compiledDanmaku['danmaku_5'] = [
  ...
  for (let _loopIdx_4 = 0, _limit_4 = Math.round(1200000000); _loopIdx_4 < _limit_4; _loopIdx_4++) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.26);
      yield;
    }
  }
  vars['i'] = _prev_i_4;
...
window.compiledDanmaku['danmaku_6'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 200);
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_6_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['vyq9nbant']) {
      state.onceMap['vyq9nbant'] = true;
      vars['shotTimer'] = 0;
    }
...
window.compiledDanmaku['danmaku_7'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.cardSecond !== undefined ? vars.cardSecond : 0)) >= (30) && ((vars.cardSecond !== undefined ? vars.cardSecond : 0)) <= (35)))) {
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.0002);
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_8'] = [
  ...
  for (let _loopIdx_5 = 0, _limit_5 = Math.round(1200000); _loopIdx_5 < _limit_5; _loopIdx_5++) {
    ...
    for (let _loopIdx_6 = 0, _limit_6 = Math.round(3); _loopIdx_6 < _limit_6; _loopIdx_6++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.03);
        yield;
      }
    }
    vars['i'] = _prev_i_6;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 4);
      yield;
    }
...
window.compiledDanmaku['danmaku_8_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['8noob4ath']) {
      state.onceMap['8noob4ath'] = true;
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
...
window.compiledDanmaku['danmaku_9'] = [
  ...
  while (true) {
    ...
    for (let _loopIdx_11 = 0, _limit_11 = Math.round(20); _loopIdx_11 < _limit_11; _loopIdx_11++) {
      ...
      vars['i'] = _prev_i_13;
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.7);
        yield;
      }
    }
    vars['i'] = _prev_i_11;
...
window.compiledDanmaku['danmaku_9_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['s2221ri3j']) {
        state.onceMap['s2221ri3j'] = true;
        vars['x'] = (vars.tx !== undefined ? vars.tx : 0);
        vars['angle'] = 90;
      }
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['2jkgfg66t']) {
      state.onceMap['2jkgfg66t'] = true;
...
window.compiledDanmaku['danmaku_10'] = [
  ...
  while (true) {
    ...
    if (!!((((vars.cardSecond !== undefined ? vars.cardSecond : 0)) >= (15) && ((vars.cardSecond !== undefined ? vars.cardSecond : 0)) <= (30)))) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.06);
        yield;
      }
    }
    if (b && b.isDestroyed) break;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      ...
      if (!!((((vars.timer !== undefined ? vars.timer : 0)) >= (1.4) && ((vars.timer !== undefined ? vars.timer : 0)) <= (2)))) {
        vars['speed'] = 300;
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['1qf5eujgl']) {
          state.onceMap['1qf5eujgl'] = true;
          if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
            yield;
          }
          if (!!((((vars.cardSecond !== undefined ? vars.cardSecond : 0)) >= (30) && ((vars.cardSecond !== undefined ? vars.cardSecond : 0)) <= (60)))) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#33ffff").trim().toLowerCase())) {
      ...
      vars['m'] = (vars['m'] || 0) + (5);
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['z1u3ubs3f']) {
        state.onceMap['z1u3ubs3f'] = true;
        vars['y'] = 0;
        vars['xs'] = random(-600,600);
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffaa33").trim().toLowerCase())) {
      ...
      vars['m'] = (vars['m'] || 0) + (5);
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['8309xmb9d']) {
        state.onceMap['8309xmb9d'] = true;
        vars['y'] = 0;
        vars['xs'] = random(-600,600);
        vars['x'] = (vars['x'] || 0) + ((vars.xs !== undefined ? vars.xs : 0));
      }
...
window.compiledDanmaku['danmaku_11'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_27 = 0, _limit_27 = Math.round(3); _loopIdx_27 < _limit_27; _loopIdx_27++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.08);
        yield;
      }
    }
    vars['i'] = _prev_i_27;
...
window.compiledDanmaku['danmaku_11_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['zr1zruw0i']) {
      state.onceMap['zr1zruw0i'] = true;
...
window.compiledDanmaku['danmaku_13'] = function*(state, b, attacker, target, _util) {
  ...
  for (let _loopIdx_31 = 0, _limit_31 = Math.round(1200); _loopIdx_31 < _limit_31; _loopIdx_31++) {
    ...
    vars['spawnp'] = -10;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.15);
      yield;
    }
  }
  vars['i'] = _prev_i_31;
...
window.compiledDanmaku['danmaku_13_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['53qljxkcq']) {
        state.onceMap['53qljxkcq'] = true;
        vars['x'] = 379 + (vars.spawnp !== undefined ? vars.spawnp : 0) * 60;
      }
    }
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3332").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['noxwuwu3a']) {
        state.onceMap['noxwuwu3a'] = true;
        vars['x'] = 379 - (vars.spawnp !== undefined ? vars.spawnp : 0) * 60;
      }
    }
...
window.compiledDanmaku['danmaku_14'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1 - (vars.t !== undefined ? vars.t : 0));
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1 - (vars.t !== undefined ? vars.t : 0));
...
window.compiledDanmaku['danmaku_15'] = [
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 5);
      yield;
    }
  }
}
...
window.compiledDanmaku['danmaku_15_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['5kwwtdnck']) {
      state.onceMap['5kwwtdnck'] = true;
      vars['yp'] = -40;
    }
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.00001);
      yield;
    }
    if (!!((((vars.yp !== undefined ? vars.yp : 0)) >= (-5) && ((vars.yp !== undefined ? vars.yp : 0)) <= (5)))) {
      vars['SpriteAngle'] = 90;
...
window.compiledDanmaku['danmaku_16'] = function*(state, b, attacker, target, _util) {
  ...
  for (let _loopIdx_37 = 0, _limit_37 = Math.round(1200); _loopIdx_37 < _limit_37; _loopIdx_37++) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.3);
      yield;
    }
  }
  vars['i'] = _prev_i_37;
...
window.compiledDanmaku['danmaku_17'] = [
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.00005);
      yield;
    }
  }
}
...
window.compiledDanmaku['danmaku_17_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.e_t !== undefined ? vars.e_t : 0),1))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['bix29ryln']) {
        state.onceMap['bix29ryln'] = true;
        vars['flag'] = 1;
      }
    }
    if (!!(_util.fuzzyEqual((vars.flag !== undefined ? vars.flag : 0),1))) {
      ...
      if (!!((vars.x !== undefined ? vars.x : 0) < 10)) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['u85epehe1']) {
          state.onceMap['u85epehe1'] = true;
          vars['speed'] = 0;
          vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
      ...
      if (!!((vars.x !== undefined ? vars.x : 0) > 758)) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['cc9nd1j10']) {
          state.onceMap['cc9nd1j10'] = true;
          vars['speed'] = 0;
          vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
          vars['angle'] = (vars.angle !== undefined ? vars.angle : 0) - 180;
        }
      ...
      if (!!((vars.y !== undefined ? vars.y : 0) < 10)) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['41j91zsge']) {
          state.onceMap['41j91zsge'] = true;
          vars['speed'] = 0;
          vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        }
      }
      if (!!((vars.y !== undefined ? vars.y : 0) > 886)) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['fn3qqegnn']) {
          state.onceMap['fn3qqegnn'] = true;
          vars['speed'] = 0;
          vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        }
      }
  ...
  while (true) {
    ...
    while (true) {
      ...
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#dddddd").trim().toLowerCase())) {
        ...
        vars['speed'] = (vars['speed'] || 0) + (2);
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['oc6dwnu5e']) {
          state.onceMap['oc6dwnu5e'] = true;
          if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
            yield;
          }
      ...
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ddddde").trim().toLowerCase())) {
        ...
        vars['speed'] = (vars['speed'] || 0) + (2);
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['xv31t6g6c']) {
          state.onceMap['xv31t6g6c'] = true;
          if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
            yield;
          }
          vars['angle'] = (vars['angle'] || 0) + ((vars.offset !== undefined ? vars.offset : 0));
...
window.compiledDanmaku['danmaku_19'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['i'] = _prev_i_43;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 50);
      yield;
    }
  }
};
...
window.compiledDanmaku['danmaku_20'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 7);
      yield;
    }
  }
};
...
window.compiledDanmaku['danmaku_21'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 4 - (vars.w !== undefined ? vars.w : 0));
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 2);
...
window.compiledDanmaku['danmaku_23_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['pj2pmbjfc']) {
      state.onceMap['pj2pmbjfc'] = true;
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.02);
        yield;
      }
...
window.compiledDanmaku['danmaku_24_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#9E76B4").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['xhjmwwgb7']) {
        state.onceMap['xhjmwwgb7'] = true;
...
window.compiledDanmaku['danmaku_25'] = [
  ...
  if (!state.onceMap) state.onceMap = {};
  if (!state.onceMap['uvoyozg2d']) {
    state.onceMap['uvoyozg2d'] = true;
    vars['w'] = 0.6;
  }
},
  function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, (vars.w !== undefined ? vars.w : 0));
      yield;
    }
...
window.compiledDanmaku['danmaku_26'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.07);
      yield;
    }
  }
};
...
window.compiledDanmaku['danmaku_28'] = [
  ...
  for (let _loopIdx_69 = 0, _limit_69 = Math.round(12000); _loopIdx_69 < _limit_69; _loopIdx_69++) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.02 - (vars.t !== undefined ? vars.t : 0));
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.01);
...
window.compiledDanmaku['danmaku_29'] = [
  ...
  while (true) {
    ...
    for (let _loopIdx_72 = 0, _limit_72 = Math.round(5000); _loopIdx_72 < _limit_72; _loopIdx_72++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.000005);
        yield;
      }
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#fffffe").trim().toLowerCase())) {
      if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (2) && ((vars.frame !== undefined ? vars.frame : 0)) <= (3)))) {
        vars['speed'] = 320;
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['xn08xmcps']) {
          state.onceMap['xn08xmcps'] = true;
          vars['angle'] = (vars['angle'] || 0) + (180);
        }
      }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffff99").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['wc2lbjlgt']) {
        state.onceMap['wc2lbjlgt'] = true;
...
window.compiledDanmaku['danmaku_30_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.timer !== undefined ? vars.timer : 0) ,(vars.henkat !== undefined ? vars.henkat : 0)))) {
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['zviq8s3cv']) {
          state.onceMap['zviq8s3cv'] = true;
          if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
            yield;
          }
        }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#33ff88").trim().toLowerCase())) {
      if (!!((vars.isTouchEdge !== undefined ? vars.isTouchEdge : 0))) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['1zdvk91fo']) {
          state.onceMap['1zdvk91fo'] = true;
          if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
            yield;
          }
        }
...
window.compiledDanmaku['danmaku_32'] = [
  ...
  if (!state.onceMap) state.onceMap = {};
  if (!state.onceMap['vzhokxza8']) {
    state.onceMap['vzhokxza8'] = true;
    vars['t'] = 1.5;
  }
},
  function*(state, b, attacker, target, _util) {
  ...
  for (let _loopIdx_75 = 0, _limit_75 = Math.round(1200); _loopIdx_75 < _limit_75; _loopIdx_75++) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, (vars.t !== undefined ? vars.t : 0));
      yield;
    }
    vars['t'] = (vars['t'] || 0) - (0.05);
  }
...
window.compiledDanmaku['danmaku_34'] = function*(state, b, attacker, target, _util) {
  ...
  for (let _loopIdx_77 = 0, _limit_77 = Math.round(6); _loopIdx_77 < _limit_77; _loopIdx_77++) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1.15);
      yield;
    }
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 3.5);
      yield;
    }
    vars['w'] = (vars['w'] || 0) + (1);
  }
  ...
  while (true) {
    ...
    while (true) {
      ...
      for (let _loopIdx_80 = 0, _limit_80 = Math.round(38); _loopIdx_80 < _limit_80; _loopIdx_80++) {
        ...
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.16);
          yield;
        }
        if (_util.executeBlock({ type: 'play_sound', soundName: "shot", }, state, b, attacker, target, _util)) {
          yield;
  ...
  while (true) {
    ...
    while (true) {
      ...
      for (let _loopIdx_86 = 0, _limit_86 = Math.round(4); _loopIdx_86 < _limit_86; _loopIdx_86++) {
        ...
        vars['angle'] = (vars['angle'] || 0) + (6);
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.025);
          yield;
        }
      }
      vars['i'] = _prev_i_86;
...
window.compiledDanmaku['danmaku_40_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (2) && ((vars.frame !== undefined ? vars.frame : 0)) <= (4)))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['23n4cgpzc']) {
        state.onceMap['23n4cgpzc'] = true;
        vars['speed'] = 80;
        vars['angle'] = (vars['angle'] || 0) + (180);
    ...
    if (!!(_util.fuzzyEqual((vars.timer !== undefined ? vars.timer : 0) ,7.5))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['67kfy31qd']) {
        state.onceMap['67kfy31qd'] = true;
        vars['speed'] = 30;
        vars['color'] = "#dddddd";
      }
    }
...
window.compiledDanmaku['danmaku_41'] = [
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 15);
      yield;
    }
  }
}
...
window.compiledDanmaku['danmaku_42'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['stop'] = 0;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1.5 - (vars.minus !== undefined ? vars.minus : 0));
      yield;
    }
...
window.compiledDanmaku['danmaku_43'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['i'] = _prev_i_91;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 20);
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_43_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['kfkhxy3h9']) {
      state.onceMap['kfkhxy3h9'] = true;
      vars['hitRadius'] = 0;
...
window.compiledDanmaku['danmaku_44'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 9);
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_44_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((vars.x !== undefined ? vars.x : 0) < 10)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['lbrwifnvo']) {
        state.onceMap['lbrwifnvo'] = true;
        if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if (!!((vars.x !== undefined ? vars.x : 0) > 758)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['roaw9x6mg']) {
        state.onceMap['roaw9x6mg'] = true;
        if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if (!!((vars.y !== undefined ? vars.y : 0) < 10)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['8s1jnjr2b']) {
        state.onceMap['8s1jnjr2b'] = true;
        if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if (!!((vars.y !== undefined ? vars.y : 0) > 886)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['f396064q5']) {
        state.onceMap['f396064q5'] = true;
        vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_47_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((vars.x !== undefined ? vars.x : 0) < 10)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['ij1be6u6x']) {
        state.onceMap['ij1be6u6x'] = true;
        vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        vars['angle'] = (vars['angle'] || 0) + (180);
        vars['speed'] = 0;
      }
    ...
    if (!!((vars.x !== undefined ? vars.x : 0) > 758)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['cwqy9y69f']) {
        state.onceMap['cwqy9y69f'] = true;
        vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        vars['angle'] = (vars['angle'] || 0) + (180);
        vars['speed'] = 0;
      }
    ...
    if (!!((vars.y !== undefined ? vars.y : 0) < 10)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['inxpv07e1']) {
        state.onceMap['inxpv07e1'] = true;
        vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        vars['speed'] = 0;
      }
    }
    if (!!((vars.y !== undefined ? vars.y : 0) > 886)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['fgnp0t877']) {
        state.onceMap['fgnp0t877'] = true;
        vars['angle'] = -(vars.angle !== undefined ? vars.angle : 0);
        vars['speed'] = 0;
      }
    }
...
window.compiledDanmaku['danmaku_48'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.6666666667);
      yield;
    }
    if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
      yield;
...
window.compiledDanmaku['danmaku_48_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (3) && ((vars.frame !== undefined ? vars.frame : 0)) <= (870000)))) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.007);
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_52'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_97 = 0, _limit_97 = Math.round(48); _loopIdx_97 < _limit_97; _loopIdx_97++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.035);
        yield;
      }
      if (_util.executeBlock({ type: 'play_sound', soundName: "shot", }, state, b, attacker, target, _util)) {
        yield;
    ...
    vars['i'] = _prev_i_99;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 2.2 - (vars.hakkyou !== undefined ? vars.hakkyou : 0));
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1 - (vars.hakkyou2 !== undefined ? vars.hakkyou2 : 0));
      yield;
    }
...
window.compiledDanmaku['danmaku_52_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (260) && ((vars.frame !== undefined ? vars.frame : 0)) <= (305)))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['hohba137n']) {
        state.onceMap['hohba137n'] = true;
    ...
    if (!!((vars.frame !== undefined ? vars.frame : 0) > 305)) {
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 99999);
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_53_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (260) && ((vars.frame !== undefined ? vars.frame : 0)) <= (305)))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['7cnnvvbk2']) {
        state.onceMap['7cnnvvbk2'] = true;
        vars['angle'] = (vars['angle'] || 0) - (90);
        vars['angle'] = (vars['angle'] || 0) + ((vars.ikouangle !== undefined ? vars.ikouangle : 0) * 3);
        vars['speed'] = 0;
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
...
window.compiledDanmaku['danmaku_54'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_105 = 0, _limit_105 = Math.round(60); _loopIdx_105 < _limit_105; _loopIdx_105++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.016);
        yield;
      }
    }
    vars['i'] = _prev_i_105;
...
window.compiledDanmaku['danmaku_55'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['i'] = _prev_i_106;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 400);
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_55_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!!((((vars.second !== undefined ? vars.second : 0)) >= (15) && ((vars.second !== undefined ? vars.second : 0)) <= (30000)))) {
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 99999999);
        yield;
      }
    }
    if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
...
window.compiledDanmaku['danmaku_56_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#9457eb").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['f3zu00lo8']) {
        state.onceMap['f3zu00lo8'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['wrtdwvph7']) {
        state.onceMap['wrtdwvph7'] = true;
...
window.compiledDanmaku['danmaku_57'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_107 = 0, _limit_107 = Math.round(10); _loopIdx_107 < _limit_107; _loopIdx_107++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.13);
        yield;
      }
    }
    vars['i'] = _prev_i_107;
...
window.compiledDanmaku['danmaku_58_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['qs3pwjpqz']) {
      state.onceMap['qs3pwjpqz'] = true;
...
window.compiledDanmaku['danmaku_59_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['2sac1nseb']) {
      state.onceMap['2sac1nseb'] = true;
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() !== String("#33ffff").trim().toLowerCase())) {
...
window.compiledDanmaku['danmaku_60_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffaa32").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['7mbv47fom']) {
        state.onceMap['7mbv47fom'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#3387ff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['uacxsrbli']) {
        state.onceMap['uacxsrbli'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
...
window.compiledDanmaku['danmaku_61_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffaa32").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['1qsz6t1eg']) {
        state.onceMap['1qsz6t1eg'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#3387ff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['w5tho0d36']) {
        state.onceMap['w5tho0d36'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
      }
...
window.compiledDanmaku['danmaku_63_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['9tc3m77o2']) {
      state.onceMap['9tc3m77o2'] = true;
...
window.compiledDanmaku['danmaku_64_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() !== String("#33ffff").trim().toLowerCase())) {
      ...
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['ubox90oig']) {
        state.onceMap['ubox90oig'] = true;
        vars['speed'] = 100;
      }
      vars['speed'] = (vars['speed'] || 0) + (0.5);
    }
...
window.compiledDanmaku['danmaku_65'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_138 = 0, _limit_138 = Math.round(10); _loopIdx_138 < _limit_138; _loopIdx_138++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.016 / 8);
        yield;
      }
    }
    vars['i'] = _prev_i_138;
...
window.compiledDanmaku['danmaku_66_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['ylav69gnf']) {
      state.onceMap['ylav69gnf'] = true;
...
window.compiledDanmaku['danmaku_67_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['j6hu1sgr2']) {
        state.onceMap['j6hu1sgr2'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffffff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['44y7stxbe']) {
        state.onceMap['44y7stxbe'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#33ffff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['wuc5cq61a']) {
        state.onceMap['wuc5cq61a'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['x'] = (vars['x'] || 0) + ((vars.offsetx !== undefined ? vars.offsetx : 0));
...
window.compiledDanmaku['danmaku_68_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['m1h1iv9rr']) {
      state.onceMap['m1h1iv9rr'] = true;
      vars['count'] = 0;
      vars['angle'] = (vars['angle'] || 0) + (random(-10,10));
    }
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffffff").trim().toLowerCase())) {
...
window.compiledDanmaku['danmaku_70'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.1-(vars.hindo !== undefined ? vars.hindo : 0));
      yield;
    }
...
window.compiledDanmaku['danmaku_70_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['rmetwcsp1']) {
      state.onceMap['rmetwcsp1'] = true;
      vars['y'] = (vars['y'] || 0) - (100);
      vars['speed'] = 400;
    ...
    if (!!(abs((vars.y !== undefined ? vars.y : 0)  - (vars.ty !== undefined ? vars.ty : 0)) <= 20)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['9219e6kwt']) {
        state.onceMap['9219e6kwt'] = true;
        vars['speed'] = 0;
        vars['angle'] = 90;
...
window.compiledDanmaku['danmaku_70_magic'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    vars['speed'] = (vars['speed'] || 0) + (1);
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['gi8wtez9q']) {
      state.onceMap['gi8wtez9q'] = true;
...
window.compiledDanmaku['danmaku_71_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['3zc4cnon3']) {
      state.onceMap['3zc4cnon3'] = true;
...
window.compiledDanmaku['danmaku_73_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['36e6pns4g']) {
      state.onceMap['36e6pns4g'] = true;
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (240) && ((vars.frame !== undefined ? vars.frame : 0)) <= (241)))) {
      vars['speed'] = 300;
      vars['color'] = (vars.motocolor !== undefined ? vars.motocolor : 0);
      vars['hitRadius'] = 3;
    }
    if (b && b.isDestroyed) break;
    state.waitTimer = Math.max(state.waitTimer || 0, state.dt || 0.0167);
...
window.compiledDanmaku['danmaku_74'] = [
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.0334);
      yield;
    }
  }
},
...
window.compiledDanmaku['danmaku_74_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['ngi05wvv7']) {
      state.onceMap['ngi05wvv7'] = true;
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
...
window.compiledDanmaku['danmaku_75'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_145 = 0, _limit_145 = Math.round(3); _loopIdx_145 < _limit_145; _loopIdx_145++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.0835);
        yield;
      }
    }
    vars['i'] = _prev_i_145;
...
window.compiledDanmaku['danmaku_76_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['223tgzunh']) {
      state.onceMap['223tgzunh'] = true;
...
window.compiledDanmaku['danmaku_77_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['8cl4llbcw']) {
      state.onceMap['8cl4llbcw'] = true;
      if (_util.executeBlock({ type: 'advance', distance: "10", }, state, b, attacker, target, _util)) {
        yield;
      }
...
window.compiledDanmaku['danmaku_78'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_149 = 0, _limit_149 = Math.round(4); _loopIdx_149 < _limit_149; _loopIdx_149++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.167 * 5);
        yield;
      }
    }
    vars['i'] = _prev_i_149;
...
window.compiledDanmaku['danmaku_78_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffffff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['3wh1qxso9']) {
        state.onceMap['3wh1qxso9'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#fffffe").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['axbht7ofb']) {
        state.onceMap['axbht7ofb'] = true;
        if (_util.executeBlock({ type: 'advance', distance: "-100", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['multf'] = 30;
...
window.compiledDanmaku['danmaku_79_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['l7vgq6a1c']) {
      state.onceMap['l7vgq6a1c'] = true;
...
window.compiledDanmaku['danmaku_s2_0'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#33ccff", speed: "180", angle: "angle", count: "6", offsetX: "0", offsetY: "0", radius: "8", bulletImage: "star", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3388", speed: "140", angle: "angle + 30", count: "6", offsetX: "0", offsetY: "0", radius: "8", bulletImage: "star", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.18);
      yield;
    }
  }
};
...
window.compiledDanmaku['danmaku_s2_1'] = [
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['7rtfsvdvh']) {
      state.onceMap['7rtfsvdvh'] = true;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 2.0);
      yield;
    }
    while (true) {
      if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_1_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#888888").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['18m8r2274']) {
        state.onceMap['18m8r2274'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#000000").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['0xigfikou']) {
        state.onceMap['0xigfikou'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['3oxex51y9']) {
        state.onceMap['3oxex51y9'] = true;
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffaa33").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['k8mbcxqfu']) {
        state.onceMap['k8mbcxqfu'] = true;
        if (_util.executeBlock({ type: 'advance', distance: "90", }, state, b, attacker, target, _util)) {
          yield;
        }
...
window.compiledDanmaku['danmaku_s2_2_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() !== String("#888888").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['vnoh6z0rd']) {
        state.onceMap['vnoh6z0rd'] = true;
        ...
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 2.3);
          yield;
        }
        if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
          if (!b || !b.isDestroyed) {
            state.waitTimer = Math.max(1 / 60, (vars.kawaru !== undefined ? vars.kawaru : 0));
            yield;
          }
        }
        if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#3388ff").trim().toLowerCase())) {
          if (!b || !b.isDestroyed) {
            state.waitTimer = Math.max(1 / 60, (vars.kawaru2 !== undefined ? vars.kawaru2 : 0));
            yield;
          }
        }
        ...
        if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
          if (!b || !b.isDestroyed) {
            state.waitTimer = Math.max(1 / 60, 1 - (vars.kawaru !== undefined ? vars.kawaru : 0));
            yield;
          }
        }
        if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#3388ff").trim().toLowerCase())) {
          if (!b || !b.isDestroyed) {
            state.waitTimer = Math.max(1 / 60, 1 - (vars.kawaru2 !== undefined ? vars.kawaru2 : 0));
            yield;
          }
        }
        vars['speed'] = 200;
...
window.compiledDanmaku['danmaku_s2_3'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    for (let _loopIdx_153 = 0, _limit_153 = Math.round(5); _loopIdx_153 < _limit_153; _loopIdx_153++) {
      ...
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 0.0167 * 11);
        yield;
      }
      vars['s'] = (vars['s'] || 0) + (11);
    }
...
window.compiledDanmaku['danmaku_s2_3_magic'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['fumvxrtg4']) {
      state.onceMap['fumvxrtg4'] = true;
...
window.compiledDanmaku['danmaku_s2_4'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.0167 * 60);
      yield;
    }
    vars['spd'] = 0;
    vars['wa'] = 0;
...
window.compiledDanmaku['danmaku_s2_4_bullet'] = function*(state, b, attacker, target, _util) {
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['d8d09tz0k']) {
      state.onceMap['d8d09tz0k'] = true;
...
window.compiledDanmaku['danmaku_s2_6'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    for (let _loopIdx_165 = 0, _limit_165 = Math.round(10); _loopIdx_165 < _limit_165; _loopIdx_165++) {
      vars['i'] = _loopIdx_165;
      if (_util.executeBlock({ type: 'spawn_bullet', bulletType: "normal", color: "#ff3333", speed: "200", angle: "angle", offsetX: "0", offsetY: "0", radius: "10", bulletImage: "redgun", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'spawn_bullet', bulletType: "normal", color: "#ff3333", speed: "200", angle: "180+angle", offsetX: "0", offsetY: "0", radius: "10", bulletImage: "redgun", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['i'] = _prev_i_165;
...
window.compiledDanmaku['danmaku_s2_6_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['ry0837med']) {
      state.onceMap['ry0837med'] = true;
...
window.compiledDanmaku['danmaku_s2_6_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_7'] = [
  function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  ...
  while (true) {
    ...
    vars['angle'] = random(0,360);
    vars['muki'] = 1;
    if (_util.executeBlock({ type: 'spawn_ring_resist', bulletType: "normal", color: "#ff3333", speed: "500", angle: "angle", count: "72", offsetX: "0", offsetY: "0", radius: "8", bulletImage: "yellowgun", coordMode: "relative", hitRadius: "4", }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['muki'] = -1;
    if (_util.executeBlock({ type: 'spawn_ring_resist', bulletType: "normal", color: "#ff3333", speed: "500", angle: "angle + 2.5", count: "72", offsetX: "0", offsetY: "0", radius: "8", bulletImage: "yellowgun", coordMode: "relative", hitRadius: "4", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 0.167 * 8);
      yield;
    }
  }
},
  ...
  while (true) {
    ...
    while (true) {
      ...
      for (let _loopIdx_166 = 0, _limit_166 = Math.round(4); _loopIdx_166 < _limit_166; _loopIdx_166++) {
        vars['i'] = _loopIdx_166;
        if (_util.executeBlock({ type: 'spawn_ring_resist', bulletType: "normal", color: "#33ff88", speed: "300 + spd", angle: "angle", count: "24", offsetX: "0", offsetY: "0", radius: "20", bulletImage: "light", coordMode: "relative", hitRadius: "10", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['spd'] = (vars['spd'] || 0) + (50);
      }
...
window.compiledDanmaku['danmaku_s2_7_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['0be96fsqp']) {
      state.onceMap['0be96fsqp'] = true;
      if (_util.executeBlock({ type: 'advance', distance: "20", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,20))) {
      if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "100", mode: "seconds", duration: "0.6", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'tween_angle', from: "angle", to: "angle + 80 * muki", mode: "seconds", duration: "0.6", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
      let _prev_i_167 = vars['i'];
      for (let _loopIdx_167 = 0, _limit_167 = Math.round(60); _loopIdx_167 < _limit_167; _loopIdx_167++) {
        vars['i'] = _loopIdx_167;
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.01);
      ...
      vars['i'] = _prev_i_167;
      if (_util.executeBlock({ type: 'tween_angle', from: "angle", to: "angle + 20 * muki", mode: "seconds", duration: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
...
window.compiledDanmaku['danmaku_s2_7_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_8'] = [
  function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (6000) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (8000)))) {
      vars['spd'] = 0;
      if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
        yield;
      }
      let _prev_i_168 = vars['i'];
      for (let _loopIdx_168 = 0, _limit_168 = Math.round(18); _loopIdx_168 < _limit_168; _loopIdx_168++) {
        vars['i'] = _loopIdx_168;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle + 90", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "blueamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['spd'] = (vars['spd'] || 0) + (15);
        vars['angle'] = (vars['angle'] || 0) + (5);
      }
      vars['i'] = _prev_i_168;
      let _prev_i_169 = vars['i'];
      for (let _loopIdx_169 = 0, _limit_169 = Math.round(18); _loopIdx_169 < _limit_169; _loopIdx_169++) {
        vars['i'] = _loopIdx_169;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle + 90", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "blueamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (4000) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (6000)))) {
      vars['spd'] = 0;
      vars['angle'] = 0 + (vars.kaku !== undefined ? vars.kaku : 0);
      let _prev_i_170 = vars['i'];
      for (let _loopIdx_170 = 0, _limit_170 = Math.round(9); _loopIdx_170 < _limit_170; _loopIdx_170++) {
        vars['i'] = _loopIdx_170;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "redamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "-angle", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "redamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
      ...
      for (let _loopIdx_171 = 0, _limit_171 = Math.round(9); _loopIdx_171 < _limit_171; _loopIdx_171++) {
        vars['i'] = _loopIdx_171;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "redamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
  ...
  while (true) {
    ...
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (2000) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (4000)))) {
      ...
      for (let _loopIdx_172 = 0, _limit_172 = Math.round(18); _loopIdx_172 < _limit_172; _loopIdx_172++) {
        vars['i'] = _loopIdx_172;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "greenamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['spd'] = (vars['spd'] || 0) + (15);
        vars['angle'] = (vars['angle'] || 0) + (5);
      ...
      for (let _loopIdx_173 = 0, _limit_173 = Math.round(18); _loopIdx_173 < _limit_173; _loopIdx_173++) {
        vars['i'] = _loopIdx_173;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "2", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "greenamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
  ...
  while (true) {
    ...
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (0) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (2000)))) {
      ...
      for (let _loopIdx_174 = 0, _limit_174 = Math.round(9); _loopIdx_174 < _limit_174; _loopIdx_174++) {
        vars['i'] = _loopIdx_174;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "1", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "redamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle + 120", count: "1", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "blueamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle + 240", count: "1", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "greenamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['spd'] = (vars['spd'] || 0) + (15);
        vars['angle'] = (vars['angle'] || 0) + (6);
      ...
      for (let _loopIdx_175 = 0, _limit_175 = Math.round(9); _loopIdx_175 < _limit_175; _loopIdx_175++) {
        vars['i'] = _loopIdx_175;
        if (_util.executeBlock({ type: 'spawn_way', bulletType: "normal", color: "#ff3333", speed: "200 + spd", angle: "angle", count: "1", spread: "180", offsetX: "0", offsetY: "0", radius: "9", bulletImage: "redamulet", coordMode: "relative", hitRadius: "5", }, state, b, attacker, target, _util)) {
          yield;
        }
  ...
  while (true) {
    ...
    vars['idoux'] = 368 + random(-150,150);
    vars['idouy'] = 200 + random(-100,100);
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "idoux", mode: "seconds", duration: "1", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "idouy", mode: "seconds", duration: "1", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
  }
}
];
window.compiledDanmaku['danmaku_s2_8_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['3tso71sr8']) {
      state.onceMap['3tso71sr8'] = true;
      vars['angle'] = (vars['angle'] || 0) + (random(-5,5));
    }
    vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_8_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_9'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    for (let _loopIdx_176 = 0, _limit_176 = Math.round(30); _loopIdx_176 < _limit_176; _loopIdx_176++) {
      vars['i'] = _loopIdx_176;
      if (_util.executeBlock({ type: 'spawn_bullet', bulletType: "normal", color: "#ff3333", speed: "200", angle: "90", offsetX: "spx + 10", offsetY: "0", radius: "10", bulletImage: "purpleamulet", coordMode: "absolute", hitRadius: "3", }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['spx'] = (vars['spx'] || 0) + (30);
    }
    vars['i'] = _prev_i_176;
    vars['r'] = random(0,500);
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3333", speed: "200", angle: "r", count: "100", offsetX: "0", offsetY: "0", radius: "10", bulletImage: "redamulet", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3333", speed: "200", angle: "r", count: "36", offsetX: "300", offsetY: "0", radius: "10", bulletImage: "orangeamulet", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3333", speed: "200", angle: "r", count: "36", offsetX: "-300", offsetY: "0", radius: "10", bulletImage: "yellowamulet", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3333", speed: "200", angle: "r", count: "36", offsetX: "350", offsetY: "200", radius: "10", bulletImage: "greenamulet", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'spawn_ring', bulletType: "normal", color: "#ff3333", speed: "200", angle: "r", count: "36", offsetX: "-350", offsetY: "200", radius: "10", bulletImage: "blueamulet", coordMode: "relative", hitRadius: "3", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 1);
...
window.compiledDanmaku['danmaku_s2_9_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_9_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_10'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    vars['muki'] = 1;
    if (_util.executeBlock({ type: 'bullet', bulletType: "life", bulletImage: "b_star", speed: "300", angle: "angle + 45", radius: "35", hitRadius: "40", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffdd33", health: "100", destroyResist: "true", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['muki'] = -1;
    if (_util.executeBlock({ type: 'bullet', bulletType: "life", bulletImage: "b_star", speed: "300", angle: "angle", radius: "35", hitRadius: "40", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffdd33", health: "100", destroyResist: "true", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = Math.max(1 / 60, 6);
...
window.compiledDanmaku['danmaku_s2_10_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ffdd33").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['6sf942th0']) {
        state.onceMap['6sf942th0'] = true;
        ...
        for (let _loopIdx_177 = 0, _limit_177 = Math.round(60); _loopIdx_177 < _limit_177; _loopIdx_177++) {
          vars['i'] = _loopIdx_177;
          vars['spriteAngle'] = (vars['spriteAngle'] || 0) + (5 * (vars.muki !== undefined ? vars.muki : 0));
          if (!b || !b.isDestroyed) {
        ...
        vars['i'] = _prev_i_177;
        if (_util.executeBlock({ type: 'tween_var', name: "angle", from: "angle", to: "angle - 180", mode: "seconds", duration: "4", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      vars['spriteAngle'] = (vars['spriteAngle'] || 0) + (5 * (vars.muki !== undefined ? vars.muki : 0));
      if (!!((vars.n !== undefined ? (vars.cardFrame === 5 * vars.n) : (Math.round(vars.cardFrame / 5) >= 1 && Math.abs(vars.cardFrame - 5 * Math.round(vars.cardFrame / 5)) < 0.017)))) {
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redscale", speed: "200", angle: "angle - 90", radius: "10", hitRadius: "4", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,300))) {
        vars['y'] = -900000;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_10_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_11'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    for (let _loopIdx_178 = 0, _limit_178 = Math.round(120); _loopIdx_178 < _limit_178; _loopIdx_178++) {
      vars['i'] = _loopIdx_178;
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_red", speed: "200", angle: "angle", radius: "20", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffaa33", health: "200", destroyResist: "false", way: "8", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['angle'] = (vars['angle'] || 0) + (31.3);
      if (!b || !b.isDestroyed) {
        state.waitTimer = (1) / 60;
        yield;
      }
    ...
    for (let _loopIdx_179 = 0, _limit_179 = Math.round(50); _loopIdx_179 < _limit_179; _loopIdx_179++) {
      vars['i'] = _loopIdx_179;
      if (!b || !b.isDestroyed) {
        state.waitTimer = (1) / 60;
        yield;
      ...
      for (let _loopIdx_180 = 0, _limit_180 = Math.round(4); _loopIdx_180 < _limit_180; _loopIdx_180++) {
        vars['i'] = _loopIdx_180;
        if (_util.executeBlock({ type: 'bullet', bulletType: "life", bulletImage: "bluenormal", speed: "0", angle: "angle", radius: "6", hitRadius: "20", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#6688ff", health: "30", destroyResist: "false", way: "2", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) + (3.6);
      }
      vars['i'] = _prev_i_180;
    }
    vars['i'] = _prev_i_179;
    vars['fl'] = 0;
    if (!b || !b.isDestroyed) {
      state.waitTimer = (200) / 60;
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_s2_11_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#6688ff").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['i5j8tmutp']) {
        state.onceMap['i5j8tmutp'] = true;
        vars['hensuu'] = random(50,200);
        if (_util.executeBlock({ type: 'advance', distance: "hensuu", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "20", to: "6", mode: "seconds", duration: "0.5", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.5);
        ...
        vars['image'] = "light";
        if (b) b.bulletImage = "light";
        if (!b || !b.isDestroyed) {
          state.waitTimer = (55 - (vars.fl !== undefined ? vars.fl : 0)) / 60;
          yield;
        }
        vars['hitRadius'] = 6;
        vars['angle'] = (vars['angle'] || 0) + (180 + random(-18,18));
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "20 + hensuu", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    }
    if (!!((vars.isDestroyed !== undefined ? vars.isDestroyed : 0))) {
      if (typeof cpu !== 'undefined' && cpu) {
        cpu.hp = Math.max(0, cpu.hp - (2));
        vars['enemyHp'] = cpu.hp;
        if (cpu.hp <= 0 && typeof handleBossDefeat === 'function') handleBossDefeat(false);
      } else {
        vars['enemyHp'] = (vars['enemyHp'] || 0) - (2);
      }
    }
    if (b && b.isDestroyed) break;
    state.waitTimer = Math.max(state.waitTimer || 0, state.dt || 0.0167);
...
window.compiledDanmaku['danmaku_s2_11_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_12'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    vars['angle'] = random(0,360);
    vars['spx'] = random(360,430);
    vars['spy'] = random(50,800);
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "kunai2", speed: "200", angle: "angle", radius: "12", hitRadius: "6", coordMode: "absolute", isAbsolute: "true", offsetX: "spx * 1.8", offsetY: "spy", color: "#ff3333", health: "200", destroyResist: "true", way: "6", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
...
window.compiledDanmaku['danmaku_s2_12_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['xfb6dvteo']) {
      state.onceMap['xfb6dvteo'] = true;
      vars['syoyou'] = random(0.5,2);
      vars['syoyou2'] = random(2,7);
      vars['kakudo'] = random(-0.5,0.5);
      if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "0", to: "300", mode: "seconds", duration: "syoyou", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (!!((vars.x !== undefined ? vars.x : 0) < 400)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['538swrxdr']) {
        state.onceMap['538swrxdr'] = true;
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (60) && ((vars.frame !== undefined ? vars.frame : 0)) <= (100)))) {
      vars['angle'] = (vars['angle'] || 0) + ((vars.kakudo !== undefined ? vars.kakudo : 0));
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
    if (b && b.isDestroyed) break;
    state.waitTimer = Math.max(state.waitTimer || 0, state.dt || 0.0167);
...
window.compiledDanmaku['danmaku_s2_12_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_13'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_red", speed: "200", angle: "angle", radius: "20", hitRadius: "25", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "72", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['angle'] = (vars['angle'] || 0) + (3);
    if (!b || !b.isDestroyed) {
...
window.compiledDanmaku['danmaku_s2_13_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['2ejsvqy7s']) {
        state.onceMap['2ejsvqy7s'] = true;
        if (_util.executeBlock({ type: 'advance', distance: "10", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      if (!!((vars.dist !== undefined ? vars.dist : 0) < 150)) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['kb74jibzx']) {
          state.onceMap['kb74jibzx'] = true;
          vars['speed'] = 0;
          vars['bulletImage'] = "rednormal";
          vars['image'] = "rednormal";
          if (b) b.bulletImage = "rednormal";
          if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "40", to: "10", mode: "seconds", duration: "0.4", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
            yield;
          }
          vars['hitRadius'] = 10;
          if (!b || !b.isDestroyed) {
          ...
          if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "40", to: "0", mode: "seconds", duration: "0.4", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
            yield;
          }
          if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
            yield;
          }
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "0", angle: "angle", radius: "20", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
          }
          vars['y'] = -8000000;
        }
...
window.compiledDanmaku['danmaku_s2_13_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,30))) {
      if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "0", to: "200", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_14'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "none", speed: "200", angle: "angle", radius: "0", hitRadius: "", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "18", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "100", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['angle'] = random(0,360);
    if (!b || !b.isDestroyed) {
...
window.compiledDanmaku['danmaku_s2_14_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!((vars.n !== undefined ? (vars.cardFrame === 30 * vars.n) : (Math.round(vars.cardFrame / 30) >= 1 && Math.abs(vars.cardFrame - 30 * Math.round(vars.cardFrame / 30)) < 0.017)))) {
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "270", radius: "40", hitRadius: "0", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "100", customVars: {}, }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_14_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['q6xok8dvm']) {
      state.onceMap['q6xok8dvm'] = true;
      ...
      if (_util.executeBlock({ type: 'tween_var', name: "transparency", from: "100", to: "50", mode: "frames", duration: "30", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (!b || !b.isDestroyed) {
        state.waitTimer = (30) / 60;
...
window.compiledDanmaku['danmaku_s2_15'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    for (let _loopIdx_181 = 0, _limit_181 = Math.round(3); _loopIdx_181 < _limit_181; _loopIdx_181++) {
      vars['i'] = _loopIdx_181;
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "tyoudan", speed: "3 + spd", angle: "angle", radius: "20", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "9", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"230"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['angle'] = (vars['angle'] || 0) + (15);
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "tyoudan", speed: "3 + spd", angle: "angle", radius: "20", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#3388ff", health: "200", destroyResist: "true", way: "9", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"-230"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['spd'] = (vars['spd'] || 0) + (random(20,100));
      vars['angle'] = (vars['angle'] || 0) + (15);
    }
    vars['i'] = _prev_i_181;
  }
};
window.compiledDanmaku['danmaku_s2_15_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['muve4ealr']) {
      state.onceMap['muve4ealr'] = true;
      vars['speed'] = (vars['speed'] || 0) + (random(0,100));
      if (!b || !b.isDestroyed) {
        state.waitTimer = (120) / 60;
        yield;
      }
      if (_util.executeBlock({ type: 'tween_var', name: "angle", from: "angle", to: "angle + muki", mode: "seconds", duration: "8", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    if (!!((vars.n !== undefined ? (vars.cardFrame === 600 * vars.n) : (Math.round(vars.cardFrame / 600) >= 1 && Math.abs(vars.cardFrame - 600 * Math.round(vars.cardFrame / 600)) < 0.017)))) {
      if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "200", mode: "seconds", duration: "2", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_15_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_16'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    for (let _loopIdx_182 = 0, _limit_182 = Math.round(13); _loopIdx_182 < _limit_182; _loopIdx_182++) {
      vars['i'] = _loopIdx_182;
      vars['spx'] = 0 + random(-80,-20);
      vars['sd'] = (vars['sd'] || 0) + (70);
      let _prev_i_183 = vars['i'];
      for (let _loopIdx_183 = 0, _limit_183 = Math.round(25); _loopIdx_183 < _limit_183; _loopIdx_183++) {
        vars['i'] = _loopIdx_183;
        vars['spx'] = (vars['spx'] || 0) + (70);
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "90", radius: "40", hitRadius: "0", coordMode: "absolute", isAbsolute: "true", offsetX: "spx", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      vars['i'] = _prev_i_183;
    ...
    vars['sd'] = -900;
    vars['time'] = 600;
    let _prev_i_184 = vars['i'];
    for (let _loopIdx_184 = 0, _limit_184 = Math.round(13); _loopIdx_184 < _limit_184; _loopIdx_184++) {
      vars['i'] = _loopIdx_184;
      vars['spx'] = 0 + random(-80,-20);
      vars['sd'] = (vars['sd'] || 0) + (70);
      let _prev_i_185 = vars['i'];
      for (let _loopIdx_185 = 0, _limit_185 = Math.round(25); _loopIdx_185 < _limit_185; _loopIdx_185++) {
        vars['i'] = _loopIdx_185;
        vars['spx'] = (vars['spx'] || 0) + (70);
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "-90", radius: "40", hitRadius: "0", coordMode: "absolute", isAbsolute: "true", offsetX: "spx", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
...
window.compiledDanmaku['danmaku_s2_16_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['w7cg8w68c']) {
      state.onceMap['w7cg8w68c'] = true;
      if (_util.executeBlock({ type: 'advance', distance: "sd - 40", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "radius", to: "10", mode: "seconds", duration: "0.5", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (!b || !b.isDestroyed) {
        state.waitTimer = (31) / 60;
        yield;
      }
      vars['radius'] = 20;
      vars['bulletImage'] = "onryou_red";
      vars['image'] = "onryou_red";
      if (b) b.bulletImage = "onryou_red";
      vars['hitRadius'] = 10;
      vars['angle'] = (vars['angle'] || 0) + (random(-40,40));
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
    if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),200))) {
      if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "0", to: "140", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_16_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_17'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    let _prev_i_186 = vars['i'];
    for (let _loopIdx_186 = 0, _limit_186 = Math.round(40); _loopIdx_186 < _limit_186; _loopIdx_186++) {
      vars['i'] = _loopIdx_186;
      vars['spd'] = (vars['spd'] || 0) + (12);
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsimple", speed: "50 + spd", angle: "angle", radius: "25", hitRadius: "15", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "12", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['i'] = _prev_i_186;
    ...
    vars['idoux'] = 378 + random(-200,200);
    vars['idouy'] = 300 + random(-200,50);
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "idoux", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "idouy", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
    ...
    let _prev_i_187 = vars['i'];
    for (let _loopIdx_187 = 0, _limit_187 = Math.round(40); _loopIdx_187 < _limit_187; _loopIdx_187++) {
      vars['i'] = _loopIdx_187;
      vars['spd'] = (vars['spd'] || 0) + (12);
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsimple", speed: "50 + spd", angle: "angle", radius: "25", hitRadius: "15", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "12", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
        yield;
    ...
    vars['idoux'] = (vars.tx !== undefined ? vars.tx : 0) + random(-60,60);
    vars['idouy'] = 300 + random(-200,50);
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "idoux", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
...
window.compiledDanmaku['danmaku_s2_17_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_17_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_18'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    vars['l'] = 0;
    vars['motox'] = (vars.ex !== undefined ? vars.ex : 0) + random(-50,50);
    vars['motoy'] = (vars.ey !== undefined ? vars.ey : 0) + random(-50,50);
    let _prev_i_188 = vars['i'];
    for (let _loopIdx_188 = 0, _limit_188 = Math.round(1); _loopIdx_188 < _limit_188; _loopIdx_188++) {
      vars['i'] = _loopIdx_188;
      if (_util.executeBlock({ type: 'bullet', bulletType: "life", bulletImage: "mahoujin128", speed: "0", angle: "angle", radius: "6", hitRadius: "64", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#dfafef", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"type2":"1"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['ix'] = 384 + 250 + random(-100,100);
      vars['iy'] = 250 + random(-100,100) + (vars.l !== undefined ? vars.l : 0);
      if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "ix", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "iy", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (!b || !b.isDestroyed) {
    ...
    vars['i'] = _prev_i_188;
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "motox", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "motoy", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (240) / 60;
      yield;
    }
    vars['l'] = 0;
    vars['motox'] = (vars.ex !== undefined ? vars.ex : 0) + random(-50,50);
    vars['motoy'] = (vars.ey !== undefined ? vars.ey : 0) + random(-50,50);
    let _prev_i_189 = vars['i'];
    for (let _loopIdx_189 = 0, _limit_189 = Math.round(1); _loopIdx_189 < _limit_189; _loopIdx_189++) {
      vars['i'] = _loopIdx_189;
      if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'bullet', bulletType: "life", bulletImage: "mahoujin128", speed: "50", angle: "angle", radius: "6", hitRadius: "64", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#B455A0", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"type2":"2"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['ix'] = 384 + 250 + random(-100,100);
      vars['iy'] = 250 + random(-100,100) + (vars.l !== undefined ? vars.l : 0);
...
window.compiledDanmaku['danmaku_s2_18_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.type2 !== undefined ? vars.type2 : 0) ,1))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['2ugz91fy2']) {
        state.onceMap['2ugz91fy2'] = true;
      ...
      vars['y'] = (vars['y'] || 0) + (0.4);
      vars['spriteAngle'] = (vars['spriteAngle'] || 0) + (1.3);
      if (!!((vars.n !== undefined ? (vars.frame === 25 * vars.n) : (Math.round(vars.frame / 25) >= 1 && Math.abs(vars.frame - 25 * Math.round(vars.frame / 25)) < 0.017)))) {
        vars['angle'] = (vars['angle'] || 0) + (random(0,360));
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "200", angle: "angle", radius: "9", hitRadius: "3", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffffff", health: "200", destroyResist: "false", way: "8", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,600))) {
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "64", to: "0", mode: "seconds", duration: "1", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = (60) / 60;
    ...
    if (!!(_util.fuzzyEqual((vars.type2 !== undefined ? vars.type2 : 0) ,2))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['7rbrgd485']) {
        state.onceMap['7rbrgd485'] = true;
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "0", to: "64", mode: "seconds", duration: "1", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    ...
    if (!!((vars.isDestroyed !== undefined ? vars.isDestroyed : 0))) {
      let _prev_i_190 = vars['i'];
      for (let _loopIdx_190 = 0, _limit_190 = Math.round(10); _loopIdx_190 < _limit_190; _loopIdx_190++) {
        vars['i'] = _loopIdx_190;
        vars['spd'] = (vars['spd'] || 0) + (20);
        vars['angle'] = (vars['angle'] || 0) + (random(0,30));
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "light", speed: "0 + spd", angle: "angle", radius: "1", hitRadius: "0", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "18", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
        if (typeof cpu !== 'undefined' && cpu) {
          ...
          vars['enemyHp'] = (vars['enemyHp'] || 0) + (-30);
        }
      }
      vars['i'] = _prev_i_190;
    }
...
window.compiledDanmaku['danmaku_s2_18_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['789jne74q']) {
        state.onceMap['789jne74q'] = true;
        ...
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "0", to: "30", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.8);
        ...
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "30", to: "0", mode: "seconds", duration: "0.8", stepVal: "5", easing: "easeIn", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = Math.max(1 / 60, 0.8);
...
window.compiledDanmaku['danmaku_s2_19'] = [
  function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    vars['ey'] = 348;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "yellowstar", speed: "250", angle: "sangle", radius: "6", hitRadius: "", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "6", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"1","btype":"1"}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['sangle'] = (vars['sangle'] || 0) + (178.2);
    if (!b || !b.isDestroyed) {
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    vars['ransuu'] = random(-8,8);
    vars['xr'] = random(-120,120);
    vars['yr'] = random(-120,120);
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "whitenormal", speed: "1", angle: "angle", radius: "6", hitRadius: "0", coordMode: "relative", isAbsolute: "false", offsetX: "xr", offsetY: "yr", color: "#ff3333", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"btype":"2","tien":"1"}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "bluenormal", speed: "1", angle: "angle", radius: "6", hitRadius: "0", coordMode: "relative", isAbsolute: "false", offsetX: "xr", offsetY: "yr", color: "#ff3333", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"btype":"2","tien":"2"}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "bluenormal", speed: "1", angle: "angle", radius: "6", hitRadius: "0", coordMode: "relative", isAbsolute: "false", offsetX: "xr", offsetY: "yr", color: "#3388ff", health: "200", destroyResist: "true", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"btype":"2","tien":"3"}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (30) / 60;
...
window.compiledDanmaku['danmaku_s2_19_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.btype !== undefined ? vars.btype : 0) ,1))) {
      if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
        vars['spriteAngle'] = (vars['spriteAngle'] || 0) + (6 * (vars.muki !== undefined ? vars.muki : 0));
      }
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['z8eb1uu71']) {
        state.onceMap['z8eb1uu71'] = true;
        vars['angle'] = (vars['angle'] || 0) + (random(-5,5));
      }
    }
    if (!!(_util.fuzzyEqual((vars.btype !== undefined ? vars.btype : 0) ,2))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['1eo77zuaz']) {
        state.onceMap['1eo77zuaz'] = true;
        if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) + ((vars.ransuu !== undefined ? vars.ransuu : 0));
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
      }
      if (!!(_util.fuzzyEqual((vars.tien !== undefined ? vars.tien : 0) ,1))) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['cskdk023q']) {
          state.onceMap['cskdk023q'] = true;
          vars['multf'] = 90;
          vars['multlr'] = 0.2;
          if (!b || !b.isDestroyed) {
            state.waitTimer = (50) / 60;
      ...
      if (!!(_util.fuzzyEqual((vars.tien !== undefined ? vars.tien : 0) ,2))) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['ax7kl84qy']) {
          state.onceMap['ax7kl84qy'] = true;
          vars['multf'] = 90;
          vars['multlr'] = 0;
          if (!b || !b.isDestroyed) {
            state.waitTimer = (30) / 60;
          ...
          if (_util.executeBlock({ type: 'tween_var', name: "multlr", from: "0", to: "2.5", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
          if (_util.executeBlock({ type: 'tween_var', name: "hitmultlr", from: "0", to: "1", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
          if (!b || !b.isDestroyed) {
            state.waitTimer = (20) / 60;
          ...
          if (_util.executeBlock({ type: 'tween_var', name: "multlr", from: "2.5", to: "0", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
          if (_util.executeBlock({ type: 'tween_var', name: "hitmultlr", from: "1", to: "0", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
        }
      }
      if (!!(_util.fuzzyEqual((vars.tien !== undefined ? vars.tien : 0) ,3))) {
        if (!state.onceMap) state.onceMap = {};
        if (!state.onceMap['6jzfznom1']) {
          state.onceMap['6jzfznom1'] = true;
          vars['radius'] = 0;
          if (!b || !b.isDestroyed) {
            state.waitTimer = (30) / 60;
            yield;
          }
          if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "0", to: "15", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
          if (!b || !b.isDestroyed) {
            state.waitTimer = (20) / 60;
          ...
          if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "15", to: "0", mode: "seconds", duration: "0.25", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
            yield;
          }
        }
      }
...
window.compiledDanmaku['danmaku_s2_19_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_20'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "384 + random(-200,200)", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "200 + random(-100,100)", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (50) / 60;
    ...
    while (true) {
      if (b && b.isDestroyed) break;
      let _prev_i_191 = vars['i'];
      for (let _loopIdx_191 = 0, _limit_191 = Math.round(30); _loopIdx_191 < _limit_191; _loopIdx_191++) {
        vars['i'] = _loopIdx_191;
        if (!!(!((vars.cardFrame !== undefined ? vars.cardFrame : 0) % 300 < 90))) {
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "150", angle: "angle", radius: "20", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
          }
        }
        vars['angle'] = (vars['angle'] || 0) + (19);
        if (!b || !b.isDestroyed) {
          state.waitTimer = (1) / 60;
          yield;
        }
      ...
      vars['i'] = _prev_i_191;
      vars['angle'] = (vars['angle'] || 0) + (random(-50.50));
      let _prev_i_192 = vars['i'];
      for (let _loopIdx_192 = 0, _limit_192 = Math.round(30); _loopIdx_192 < _limit_192; _loopIdx_192++) {
        vars['i'] = _loopIdx_192;
        if (!!(!((vars.cardFrame !== undefined ? vars.cardFrame : 0) % 300 < 90))) {
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "150", angle: "angle", radius: "20", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
      ...
      vars['i'] = _prev_i_192;
      if (!b || !b.isDestroyed) {
        state.waitTimer = (0) / 60;
        yield;
      }
      let _prev_i_193 = vars['i'];
      for (let _loopIdx_193 = 0, _limit_193 = Math.round(30); _loopIdx_193 < _limit_193; _loopIdx_193++) {
        vars['i'] = _loopIdx_193;
        if (!!(!((vars.cardFrame !== undefined ? vars.cardFrame : 0) % 300 < 90))) {
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "150", angle: "angle", radius: "20", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
      ...
      vars['i'] = _prev_i_193;
      if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "tx + random(-80,80)", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "200 + random(-100,100)", mode: "seconds", duration: "0.5", stepVal: "5", easing: "easeOut", }, state, b, attacker, target, _util)) {
        yield;
      ...
      vars['angle'] = (vars['angle'] || 0) + (random(-50.50));
      let _prev_i_194 = vars['i'];
      for (let _loopIdx_194 = 0, _limit_194 = Math.round(30); _loopIdx_194 < _limit_194; _loopIdx_194++) {
        vars['i'] = _loopIdx_194;
        if (!!(!((vars.cardFrame !== undefined ? vars.cardFrame : 0) % 300 < 90))) {
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "150", angle: "angle", radius: "20", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
...
window.compiledDanmaku['danmaku_s2_20_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!((vars.n !== undefined ? (vars.cardFrame === 300 * vars.n) : (Math.round(vars.cardFrame / 300) >= 1 && Math.abs(vars.cardFrame - 300 * Math.round(vars.cardFrame / 300)) < 0.017)))) {
      vars['bulletImage'] = "whiteknife";
      vars['image'] = "whiteknife";
      if (b) b.bulletImage = "whiteknife";
      vars['speed'] = 0;
      vars['kakudo'] = random(-150,150);
      vars['matu'] = random(0,90);
      if (!!((((vars.matu !== undefined ? vars.matu : 0)) >= (0) && ((vars.matu !== undefined ? vars.matu : 0)) <= (60)))) {
        if (!b || !b.isDestroyed) {
          state.waitTimer = ((vars.matu !== undefined ? vars.matu : 0)) / 60;
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) + ((vars.kakudo !== undefined ? vars.kakudo : 0));
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
        if (!b || !b.isDestroyed) {
          state.waitTimer = (60 - (vars.matu !== undefined ? vars.matu : 0)) / 60;
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = (30) / 60;
        ...
        vars['bulletImage'] = "greenknife";
        vars['image'] = "greenknife";
        if (b) b.bulletImage = "greenknife";
        vars['speed'] = 100;
      }
      if (!!((((vars.matu !== undefined ? vars.matu : 0)) >= (60) && ((vars.matu !== undefined ? vars.matu : 0)) <= (120)))) {
        if (!b || !b.isDestroyed) {
          state.waitTimer = (90) / 60;
          yield;
        }
        vars['bulletImage'] = "redknife";
        vars['image'] = "redknife";
        if (b) b.bulletImage = "redknife";
        vars['speed'] = 150;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_20_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_21'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_green", speed: "200", angle: "angle", radius: "20", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "21", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_blue", speed: "200", angle: "angle + 8.5714285715", radius: "20", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "21", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['angle'] = (vars['angle'] || 0) + (30);
    if (!b || !b.isDestroyed) {
      state.waitTimer = (12) / 60;
      yield;
    }
  }
};
window.compiledDanmaku['danmaku_s2_21_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['9nx775idt']) {
      state.onceMap['9nx775idt'] = true;
      vars['ram'] = random(-1,1);
    }
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (60) && ((vars.frame !== undefined ? vars.frame : 0)) <= (120)))) {
      if (!!((((vars.ram !== undefined ? vars.ram : 0)) >= (-1) && ((vars.ram !== undefined ? vars.ram : 0)) <= (0)))) {
        vars['angle'] = (vars['angle'] || 0) + (-1);
      }
      if (!!((((vars.ram !== undefined ? vars.ram : 0)) >= (0) && ((vars.ram !== undefined ? vars.ram : 0)) <= (1)))) {
        vars['angle'] = (vars['angle'] || 0) + (1);
      }
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
...
window.compiledDanmaku['danmaku_s2_21_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_22'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    vars['ey'] = 300;
    vars['time'] = random(10,110);
    vars['time2'] = (vars.time !== undefined ? vars.time : 0) * 2;
    vars['r'] = random(-2,2);
    vars['henkouspd'] = random(100,200);
    vars['sa'] = 0;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_blue", speed: "200", angle: "angle", radius: "40", hitRadius: "45", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['sa'] = -0.25;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_red", speed: "200", angle: "angle", radius: "40", hitRadius: "45", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['sa'] = 0.25;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_green", speed: "200", angle: "angle", radius: "40", hitRadius: "45", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
    ...
    vars['sa'] = 0.5;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_yellow", speed: "200", angle: "angle", radius: "40", hitRadius: "45", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    vars['angle'] = (vars['angle'] || 0) + (random(0,180));
    if (!b || !b.isDestroyed) {
      state.waitTimer = (20) / 60;
      yield;
    }
...
window.compiledDanmaku['danmaku_s2_22_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= ((vars.time !== undefined ? vars.time : 0)) && ((vars.frame !== undefined ? vars.frame : 0)) <= ((vars.time2 !== undefined ? vars.time2 : 0))))) {
      vars['angle'] = (vars['angle'] || 0) + ((vars.r !== undefined ? vars.r : 0) * 0);
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['pujcke343']) {
      state.onceMap['pujcke343'] = true;
      vars['speed'] = 300;
    }
    if (!!((vars.isBounced !== undefined ? vars.isBounced : 0))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['8rd7c9tro']) {
        state.onceMap['8rd7c9tro'] = true;
        if (_util.executeBlock({ type: 'bounce', }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) + ((vars.sa !== undefined ? vars.sa : 0) *50);
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "radius", to: "20", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "henkouspd", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'tween_var', name: "hitRadius", from: "hitRadius", to: "10", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    }
...
window.compiledDanmaku['danmaku_s2_22_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_23'] = [
  function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  ...
  while (true) {
    ...
    while (true) {
      if (b && b.isDestroyed) break;
      vars['angle'] = 0;
      let _prev_i_195 = vars['i'];
      for (let _loopIdx_195 = 0, _limit_195 = Math.round(10); _loopIdx_195 < _limit_195; _loopIdx_195++) {
        vars['i'] = _loopIdx_195;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "-angle +45", radius: "10", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"1"}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) - (5.5);
        if (!b || !b.isDestroyed) {
          state.waitTimer = (10) / 60;
          yield;
        }
      ...
      vars['i'] = _prev_i_195;
      let _prev_i_196 = vars['i'];
      for (let _loopIdx_196 = 0, _limit_196 = Math.round(4); _loopIdx_196 < _limit_196; _loopIdx_196++) {
        vars['i'] = _loopIdx_196;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "-angle + l + 45 + 45", radius: "10", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "10 + w", distance: "3.5", distanceType: "step", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"-1"}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['l'] = (vars['l'] || 0) + (90);
      }
      vars['i'] = _prev_i_196;
      vars['w'] = (vars['w'] || 0) + (1);
      if (!!((((vars.w !== undefined ? vars.w : 0)) >= (14) && ((vars.w !== undefined ? vars.w : 0)) <= (800)))) {
        vars['w'] = 14;
      }
      let _prev_i_197 = vars['i'];
      for (let _loopIdx_197 = 0, _limit_197 = Math.round(10); _loopIdx_197 < _limit_197; _loopIdx_197++) {
        vars['i'] = _loopIdx_197;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "-angle", radius: "10", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"-1"}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['angle'] = (vars['angle'] || 0) + (5.5);
        if (!b || !b.isDestroyed) {
      ...
      vars['i'] = _prev_i_197;
      let _prev_i_198 = vars['i'];
      for (let _loopIdx_198 = 0, _limit_198 = Math.round(4); _loopIdx_198 < _limit_198; _loopIdx_198++) {
        vars['i'] = _loopIdx_198;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "rednormal", speed: "0", angle: "-angle + l + 90 + 45", radius: "10", hitRadius: "7", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "true", way: "10 + w", distance: "3.5", distanceType: "step", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"1"}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['l'] = (vars['l'] || 0) + (90);
      }
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!!((vars.n !== undefined ? (vars.cardFrame === 80 * vars.n) : (Math.round(vars.cardFrame / 80) >= 1 && Math.abs(vars.cardFrame - 80 * Math.round(vars.cardFrame / 80)) < 0.017)))) {
      vars['sd'] = 0;
      let _prev_i_199 = vars['i'];
      for (let _loopIdx_199 = 0, _limit_199 = Math.round(5); _loopIdx_199 < _limit_199; _loopIdx_199++) {
        vars['i'] = _loopIdx_199;
        vars['sd'] = (vars['sd'] || 0) + (40);
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "tyoudan", speed: "200", angle: "180 + 20", radius: "20", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#3333ff", health: "200", destroyResist: "false", way: "2", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "tyoudan", speed: "200", angle: "180 - 20", radius: "20", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#3333ff", health: "200", destroyResist: "false", way: "2", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
...
window.compiledDanmaku['danmaku_s2_23_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['7xhc19vbc']) {
        state.onceMap['7xhc19vbc'] = true;
        if (_util.executeBlock({ type: 'advance', distance: "50", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['g'] = 50;
      }
      if (_util.executeBlock({ type: 'advance', distance: "-g", }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['angle'] = (vars['angle'] || 0) + ((vars.muki !== undefined ? vars.muki : 0) * 0.7);
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
      if (_util.executeBlock({ type: 'advance', distance: "g", }, state, b, attacker, target, _util)) {
        yield;
      }
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#3333ff").trim().toLowerCase())) {
      ...
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),60))) {
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "200", to: "0", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),120))) {
        vars['angle'] = (vars['angle'] || 0) + (random(-175,175));
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "0", to: "100 + sd", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    }
...
window.compiledDanmaku['danmaku_s2_23_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_24'] = [
  function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "384", mode: "seconds", duration: "5", stepVal: "5", easing: "easeInOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "350", mode: "seconds", duration: "5", stepVal: "5", easing: "easeInOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (240) / 60;
    ...
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "onryou_light_red", speed: "200", angle: "angle", radius: "20", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffffff", health: "200", destroyResist: "false", way: "36", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (60) / 60;
    ...
    if (_util.executeBlock({ type: 'tween_var', name: "ex", from: "ex", to: "tx + random(-60,60)", mode: "seconds", duration: "5", stepVal: "5", easing: "easeInOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'tween_var', name: "ey", from: "ey", to: "ty + random(-60,60)", mode: "seconds", duration: "5", stepVal: "5", easing: "easeInOut", }, state, b, attacker, target, _util)) {
      yield;
    }
    if (!b || !b.isDestroyed) {
      state.waitTimer = (300) / 60;
      yield;
    }
  }
}
];
window.compiledDanmaku['danmaku_s2_24_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!!((((vars.frame !== undefined ? vars.frame : 0)) >= (0) && ((vars.frame !== undefined ? vars.frame : 0)) <= (300)))) {
        vars['angle'] = (vars['angle'] || 0) + ((vars.muki !== undefined ? vars.muki : 0) * 1.5);
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_24_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_25'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (2500) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (4000)))) {
      vars['r'] = -45;
      let _prev_i_200 = vars['i'];
      for (let _loopIdx_200 = 0, _limit_200 = Math.round(45); _loopIdx_200 < _limit_200; _loopIdx_200++) {
        vars['i'] = _loopIdx_200;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsmall", speed: "200", angle: "-90 + r", radius: "0", hitRadius: "0", coordMode: "absolute", isAbsolute: "true", offsetX: "378", offsetY: "448", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['r'] = (vars['r'] || 0) + (2);
        if (!b || !b.isDestroyed) {
      ...
      for (let _loopIdx_201 = 0, _limit_201 = Math.round(45); _loopIdx_201 < _limit_201; _loopIdx_201++) {
        vars['i'] = _loopIdx_201;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsmall", speed: "200", angle: "-90 + r", radius: "0", hitRadius: "0", coordMode: "absolute", isAbsolute: "true", offsetX: "378", offsetY: "448", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
    ...
    if (!!((((vars.enemyHp !== undefined ? vars.enemyHp : 0)) >= (0) && ((vars.enemyHp !== undefined ? vars.enemyHp : 0)) <= (2500)))) {
      vars['r'] = -45;
      let _prev_i_202 = vars['i'];
      for (let _loopIdx_202 = 0, _limit_202 = Math.round(90); _loopIdx_202 < _limit_202; _loopIdx_202++) {
        vars['i'] = _loopIdx_202;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsmall", speed: "200", angle: "-90 + r", radius: "0", hitRadius: "0", coordMode: "absolute", isAbsolute: "true", offsetX: "378", offsetY: "448", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
      ...
      vars['i'] = _prev_i_202;
      let _prev_i_203 = vars['i'];
      for (let _loopIdx_203 = 0, _limit_203 = Math.round(90); _loopIdx_203 < _limit_203; _loopIdx_203++) {
        vars['i'] = _loopIdx_203;
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redsmall", speed: "200", angle: "-90 + r", radius: "0", hitRadius: "00", coordMode: "absolute", isAbsolute: "true", offsetX: "378", offsetY: "448", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['r'] = (vars['r'] || 0) - (1);
        if (!b || !b.isDestroyed) {
...
window.compiledDanmaku['danmaku_s2_25_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['z6xxbmfcm']) {
      state.onceMap['z6xxbmfcm'] = true;
      vars['speed'] = random(200,450);
    }
    if (!!((vars.y !== undefined ? vars.y : 0) < 5)) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['tdbpjc72j']) {
        state.onceMap['tdbpjc72j'] = true;
        vars['radius'] = 10;
        vars['bulletImage'] = "bluenormal";
        vars['image'] = "bluenormal";
        if (b) b.bulletImage = "bluenormal";
        vars['angle'] = 90;
        vars['motospd'] = (vars.speed !== undefined ? vars.speed : 0);
        vars['speed'] = 0;
        vars['y'] = 10;
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "40", to: "4", mode: "seconds", duration: "0.3", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (_util.executeBlock({ type: 'tween_var', name: "transparency", from: "100", to: "0", mode: "seconds", duration: "0.2", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!b || !b.isDestroyed) {
          state.waitTimer = (20) / 60;
        ...
        vars['bulletImage'] = "bluegun";
        vars['image'] = "bluegun";
        if (b) b.bulletImage = "bluegun";
        vars['radius'] = 10;
        vars['angle'] = 90;
        vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
        vars['speed'] = (vars.motospd !== undefined ? vars.motospd : 0);
        vars['hitRadius'] = 5;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_25_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_26'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    while (true) {
      if (b && b.isDestroyed) break;
      vars['matu'] = 5;
      if (!!((((vars.cardSecond !== undefined ? vars.cardSecond : 0)) >= (20) && ((vars.cardSecond !== undefined ? vars.cardSecond : 0)) <= (6000)))) {
        vars['matu'] = 3;
      }
      if (!b || !b.isDestroyed) {
        state.waitTimer = ((vars.matu !== undefined ? vars.matu : 0) * 4) / 60;
        yield;
      }
      if (_util.executeBlock({ type: 'aim_at_target', }, state, b, attacker, target, _util)) {
        yield;
      }
      vars['angle'] = (vars['angle'] || 0) + (120);
      let _prev_i_204 = vars['i'];
      for (let _loopIdx_204 = 0, _limit_204 = Math.round(20); _loopIdx_204 < _limit_204; _loopIdx_204++) {
        vars['i'] = _loopIdx_204;
        vars['angle'] = (vars['angle'] || 0) - (10);
        vars['spd'] = 0;
        vars['tamac'] = (vars['tamac'] || 0) + (1);
        let _prev_i_205 = vars['i'];
        for (let _loopIdx_205 = 0, _limit_205 = Math.round(10); _loopIdx_205 < _limit_205; _loopIdx_205++) {
          vars['i'] = _loopIdx_205;
          vars['spd'] = (vars['spd'] || 0) + (40);
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redbig", speed: "100 + spd", angle: "angle", radius: "8", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
          }
        }
        vars['i'] = _prev_i_205;
      ...
      vars['angle'] = (vars['angle'] || 0) - (120);
      let _prev_i_206 = vars['i'];
      for (let _loopIdx_206 = 0, _limit_206 = Math.round(20); _loopIdx_206 < _limit_206; _loopIdx_206++) {
        vars['i'] = _loopIdx_206;
        vars['angle'] = (vars['angle'] || 0) + (10);
        vars['spd'] = 0;
        vars['tamac'] = (vars['tamac'] || 0) + (1);
        let _prev_i_207 = vars['i'];
        for (let _loopIdx_207 = 0, _limit_207 = Math.round(10); _loopIdx_207 < _limit_207; _loopIdx_207++) {
          vars['i'] = _loopIdx_207;
          vars['spd'] = (vars['spd'] || 0) + (40);
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redbig", speed: "100 + spd", angle: "angle", radius: "8", hitRadius: "5", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
...
window.compiledDanmaku['danmaku_s2_26_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!state.onceMap) state.onceMap = {};
    if (!state.onceMap['m890hmpqf']) {
      state.onceMap['m890hmpqf'] = true;
      vars['angle'] = (vars['angle'] || 0) + (random(-2,2));
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,1 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,1 + 7 * n)) return true; } return false; } })()))) {
        ...
        vars['image'] = "redbig";
        if (b) b.bulletImage = "redbig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,2 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,2 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "orangebig";
        vars['image'] = "orangebig";
        if (b) b.bulletImage = "orangebig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,3 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,3 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "yellowbig";
        vars['image'] = "yellowbig";
        if (b) b.bulletImage = "yellowbig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,4 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,4 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "limebig";
        vars['image'] = "limebig";
        if (b) b.bulletImage = "limebig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,5 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,5 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "bluebig";
        vars['image'] = "bluebig";
        if (b) b.bulletImage = "bluebig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,6 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,6 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "purplebig";
        vars['image'] = "purplebig";
        if (b) b.bulletImage = "purplebig";
      }
      if (!!(((function(){ if (vars.n !== undefined) { const n = vars.n; return (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,7 + 7 * n)); } else { for (let n = 1; n <= 100000; n++) { if (_util.fuzzyEqual((vars.tamac !== undefined ? vars.tamac : 0) ,7 + 7 * n)) return true; } return false; } })()))) {
        vars['bulletImage'] = "pinkbig";
        vars['image'] = "pinkbig";
        if (b) b.bulletImage = "pinkbig";
      }
      if (!b || !b.isDestroyed) {
        state.waitTimer = Math.max(1 / 60, 99999999999999999);
        yield;
      }
    }
    if (b && b.isDestroyed) break;
...
window.compiledDanmaku['danmaku_s2_26_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_27'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    while (true) {
      ...
      vars['angle'] = (vars['angle'] || 0) + (120);
      let _prev_i_208 = vars['i'];
      for (let _loopIdx_208 = 0, _limit_208 = Math.round(40); _loopIdx_208 < _limit_208; _loopIdx_208++) {
        vars['i'] = _loopIdx_208;
        vars['angle'] = (vars['angle'] || 0) - (10);
        vars['spd'] = 0;
        vars['tamac'] = (vars['tamac'] || 0) + (1);
        let _prev_i_209 = vars['i'];
        for (let _loopIdx_209 = 0, _limit_209 = Math.round(10); _loopIdx_209 < _limit_209; _loopIdx_209++) {
          vars['i'] = _loopIdx_209;
          vars['spd'] = (vars['spd'] || 0) + (40);
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redbig", speed: "100 + spd", angle: "angle", radius: "15", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
          }
        }
        vars['i'] = _prev_i_209;
      ...
      vars['angle'] = (vars['angle'] || 0) - (120);
      let _prev_i_210 = vars['i'];
      for (let _loopIdx_210 = 0, _limit_210 = Math.round(40); _loopIdx_210 < _limit_210; _loopIdx_210++) {
        vars['i'] = _loopIdx_210;
        vars['angle'] = (vars['angle'] || 0) + (10);
        vars['spd'] = 0;
        vars['tamac'] = (vars['tamac'] || 0) + (1);
        let _prev_i_211 = vars['i'];
        for (let _loopIdx_211 = 0, _limit_211 = Math.round(10); _loopIdx_211 < _limit_211; _loopIdx_211++) {
          vars['i'] = _loopIdx_211;
          vars['spd'] = (vars['spd'] || 0) + (40);
          if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redbig", speed: "100 + spd", angle: "angle", radius: "15", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "1", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
            yield;
      ...
      let _prev_i_212 = vars['i'];
      for (let _loopIdx_212 = 0, _limit_212 = Math.round(10); _loopIdx_212 < _limit_212; _loopIdx_212++) {
        vars['i'] = _loopIdx_212;
        vars['spd'] = (vars['spd'] || 0) + (60);
        if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redknife", speed: "20 + spd", angle: "angle", radius: "30", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "36", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"anana":"1"}, }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      vars['i'] = _prev_i_212;
...
window.compiledDanmaku['danmaku_s2_27_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyNotEqual((vars.anana !== undefined ? vars.anana : 0) ,1))) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['8aw8lgica']) {
        state.onceMap['8aw8lgica'] = true;
...
window.compiledDanmaku['danmaku_s2_27_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_28'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    let _prev_i_213 = vars['i'];
    for (let _loopIdx_213 = 0, _limit_213 = Math.round(75); _loopIdx_213 < _limit_213; _loopIdx_213++) {
      vars['i'] = _loopIdx_213;
      vars['angle'] = (vars['angle'] || 0) + (4.8);
      vars['iku'] = random(0,300);
      vars['iku'] = (vars['iku'] || 0) + (random(-100,100));
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "cyankunai2", speed: "0", angle: "angle", radius: "20", hitRadius: "6", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"t":"1"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "cyankunai2", speed: "0", angle: "angle", radius: "20", hitRadius: "6", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"t":"2"}, }, state, b, attacker, target, _util)) {
        yield;
      }
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "cyankunai2", speed: "0", angle: "angle", radius: "20", hitRadius: "6", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "4", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"t":"3"}, }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['i'] = _prev_i_213;
    ...
    let _prev_i_214 = vars['i'];
    for (let _loopIdx_214 = 0, _limit_214 = Math.round(10); _loopIdx_214 < _limit_214; _loopIdx_214++) {
      vars['i'] = _loopIdx_214;
      if (!b || !b.isDestroyed) {
        state.waitTimer = (20) / 60;
        yield;
      ...
      if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "bluekunai2", speed: "300", angle: "angle + 5", radius: "20", hitRadius: "10", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ffffff", health: "200", destroyResist: "true", way: "24", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {}, }, state, b, attacker, target, _util)) {
        yield;
      }
    }
    vars['i'] = _prev_i_214;
...
window.compiledDanmaku['danmaku_s2_28_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if ((String((vars.color !== undefined ? vars.color : "")).trim().toLowerCase() === String("#ff3333").trim().toLowerCase())) {
      if (!state.onceMap) state.onceMap = {};
      if (!state.onceMap['ysn6w1hbe']) {
        state.onceMap['ysn6w1hbe'] = true;
        if (_util.executeBlock({ type: 'advance', distance: "iku", }, state, b, attacker, target, _util)) {
          yield;
        }
        if (!!(_util.fuzzyEqual((vars.t !== undefined ? vars.t : 0),1))) {
          vars['angle'] = (vars['angle'] || 0) + (180);
        }
        if (!!(_util.fuzzyEqual((vars.t !== undefined ? vars.t : 0),2))) {
          vars['angle'] = (vars['angle'] || 0) + (120 + 180);
        }
        if (!!(_util.fuzzyEqual((vars.t !== undefined ? vars.t : 0),3))) {
          vars['angle'] = (vars['angle'] || 0) + (-120 - 180);
        }
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "0", to: "20", mode: "seconds", duration: "0.5", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),60))) {
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "iku", mode: "seconds", duration: "2", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),120))) {
        if (!!(_util.fuzzyEqual((vars.t !== undefined ? vars.t : 0),1))) {
          vars['speed'] = (vars.iku !== undefined ? vars.iku : 0);
        }
        if (_util.executeBlock({ type: 'tween_var', name: "radius", from: "20", to: "15", mode: "seconds", duration: "1", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
        vars['hitRadius'] = 3;
      }
      if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0),200))) {
        if (_util.executeBlock({ type: 'tween_var', name: "speed", from: "speed", to: "300", mode: "seconds", duration: "5", stepVal: "5", easing: "linear", }, state, b, attacker, target, _util)) {
          yield;
        }
      }
    }
...
window.compiledDanmaku['danmaku_s2_28_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
...
window.compiledDanmaku['danmaku_s2_29'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    if (b && b.isDestroyed) break;
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redkunai2", speed: "200", angle: "angle", radius: "12", hitRadius: "3", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"1"}, }, state, b, attacker, target, _util)) {
      yield;
    }
    if (_util.executeBlock({ type: 'bullet', bulletType: "normal", bulletImage: "redkunai2", speed: "200", angle: "-angle", radius: "12", hitRadius: "3", coordMode: "relative", isAbsolute: "false", offsetX: "0", offsetY: "0", color: "#ff3333", health: "200", destroyResist: "false", way: "3", distance: "", distanceType: "total", growTime: "0.2", keepTime: "0.3", shrinkTime: "0.5", round: "true", transparency: "0", customVars: {"muki":"1"}, }, state, b, attacker, target, _util)) {
      yield;
...
window.compiledDanmaku['danmaku_s2_29_bullet'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
  ...
  while (true) {
    ...
    if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,60))) {
      vars['angle'] = (vars['angle'] || 0) + (50 * (vars.muki !== undefined ? vars.muki : 0));
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
    if (!!(_util.fuzzyEqual((vars.frame !== undefined ? vars.frame : 0) ,180))) {
      vars['angle'] = (vars['angle'] || 0) - (15 * (vars.muki !== undefined ? vars.muki : 0));
      vars['spriteAngle'] = (vars.angle !== undefined ? vars.angle : 0);
    }
    if (b && b.isDestroyed) break;
    state.waitTimer = Math.max(state.waitTimer || 0, state.dt || 0.0167);
...
window.compiledDanmaku['danmaku_s2_29_magic'] = function*(state, b, attacker, target, _util) {
  let vars = state.variables;
  const random = _util.rand;
  const rand = _util.rand;
  const seedrandom = _util.seedrandom;
